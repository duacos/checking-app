class Api::V2::TelesController < ApplicationController
  ...
  private
    ...
    def tele_params
      params.require(:tele).permit(:controles, :mecanismos, :segregacion, :politicas, :intercambio, :mensajeria, :confidencialidad, :empresa_id)
    end
end
