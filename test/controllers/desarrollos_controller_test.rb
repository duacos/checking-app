...
class DesarrollosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create desarrollo" do
    assert_difference('Desarrollo.count') do
      post desarrollos_url, params: { desarrollo: { aceptacion: @desarrollo.aceptacion, funcionalidad: @desarrollo.funcionalidad, politica: @desarrollo.politica, seguridad: @desarrollo.seguridad } }, as: :json
    end
  ...
  test "should update desarrollo" do
    patch desarrollo_url(@desarrollo), params: { desarrollo: { aceptacion: @desarrollo.aceptacion, funcionalidad: @desarrollo.funcionalidad, politica: @desarrollo.politica, seguridad: @desarrollo.seguridad } }, as: :json
    assert_response 200
  end
